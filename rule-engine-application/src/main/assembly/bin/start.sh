...
cd $BASEDIR
[[  $APP_NAME ]] || {
    export APP_NAME="rule-engine-application"
}
...
MAIN_MODULE="com.jd.cho.rule.engine.RuleEngineApplication"

#项目名
PROJECT_NAME="rule-engine-application"
JAR_NAME="${PROJECT_NAME}-1.0.0-SNAPSHOT.jar"
#main方法所在jar
