...
import static com.jd.cho.rule.engine.infr.gateway.impl.dal.mapper.RuleFactorGroupDynamicSqlSupport.*;
...
public interface RuleFactorGroupMapper {
    ...
    BasicColumn[] selectList = BasicColumn.columnList(id, groupCode, groupName, yn, createTime, modifyTime, creator, modifier, tenant);
